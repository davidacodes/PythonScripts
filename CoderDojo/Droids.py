...
def droid_hangar(inventory):
    ...
    In the corner there is one inactive repair droid still in his 
    security cylinder. You can initialise the droid to repair 
    your laser but you will require a 3 digit access code.\n 
    ''')
    print('[-DROID HANGAR-]')
...
def repair_droid(inventory, items=['laser']):
    ...
    time.sleep(1)
    print('''\nThe Repair droid is now active. You MUST connect to this droid
    with service port to repair laser.''')
...
def security(inventory):
    ...
    surveillance aboard the shuttle is done. Sentry droid 343
    has been terminated. You MUST access the Sentry droid's 
    logs but you will have to hack the data recorder.\n''')
    print('[-SECURITY-]\n')
